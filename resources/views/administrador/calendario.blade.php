    ...
    <div class="card-body card-padding">
        ...
        <input type="hidden" name="calendario" value="1">
            ...
            <div class="form-group fg-line">
                ...
                <input type="text" required="" name="nombreCalendario" class="form-control input-sm" id="exampleInputEmail1" placeholder="Nombre del evento" value="{{Calendario::find(1)->nombre}}">
            </div>
            <div class="form-group fg-line">
                <label for="exampleInputEmail1">Ubicación</label>
                <input type="text" required="" name="ubicacionCalendario" class="form-control input-sm" id="exampleInputEmail1" placeholder="Ubicación del evento" value="{{Calendario::find(1)->ubicacion}}">
            </div>
...
<div class="card">
    ...
    <div class="card-body card-padding">
        ...
        <input type="hidden" name="calendario" value="1">
            ...
            <div class="form-group fg-line">
                <label for="exampleInputEmail1">Nombre</label>
                <input type="text" required="" name="nombreCalendario" class="form-control input-sm" id="exampleInputEmail1" placeholder="Nombre del evento" value="{{Calendario::find(2)->nombre}}">
            </div>
            <div class="form-group fg-line">
                <label for="exampleInputEmail1">Ubicación</label>
                <input type="text" required="" name="ubicacionCalendario" class="form-control input-sm" id="exampleInputEmail1" placeholder="Ubicación del evento" value="{{Calendario::find(2)->ubicacion}}">
            </div>
            <p class="f-500 c-black m-b-20">Image Preview</p>
            <div class="fileinput fileinput-new" data-provides="fileinput">
                <div class="fileinput-preview thumbnail" data-trigger="fileinput">
...
<div class="card">
    ...
    <div class="card-body card-padding">
        ...
        <input type="hidden" name="calendario" value="3">
            ...
            <div class="form-group fg-line">
                <label for="exampleInputEmail1">Nombre</label>
                <input type="text" required="" name="nombreCalendario" class="form-control input-sm" id="exampleInputEmail1" placeholder="Nombre del evento" value="{{Calendario::find(3)->nombre}}">
            </div>
            <div class="form-group fg-line">
                <label for="exampleInputEmail1">Ubicación</label>
                <input type="text" required="" name="ubicacionCalendario" class="form-control input-sm" id="exampleInputEmail1" placeholder="Ubicación del evento" value="{{Calendario::find(3)->ubicacion}}">
            </div>
            <p class="f-500 c-black m-b-20">Image Preview</p>
            <div class="fileinput fileinput-new" data-provides="fileinput">
                <div class="fileinput-preview thumbnail" data-trigger="fileinput">
...
<div class="card">
    ...
    <div class="card-body card-padding">
        ...
        <input type="hidden" name="calendario" value="4">
            ...
            <div class="form-group fg-line">
                <label for="exampleInputEmail1">Nombre</label>
                <input type="text" required="" name="nombreCalendario" class="form-control input-sm" id="exampleInputEmail1" placeholder="Nombre del evento" value="{{Calendario::find(4)->nombre}}">
            </div>
            <div class="form-group fg-line">
                <label for="exampleInputEmail1">Ubicación</label>
                <input type="text" required="" name="ubicacionCalendario" class="form-control input-sm" id="exampleInputEmail1" placeholder="Ubicación del evento" value="{{Calendario::find(4)->ubicacion}}">
            </div>
            <p class="f-500 c-black m-b-20">Image Preview</p>
            <div class="fileinput fileinput-new" data-provides="fileinput">
                <div class="fileinput-preview thumbnail" data-trigger="fileinput">
